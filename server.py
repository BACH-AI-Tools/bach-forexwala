...
if API_KEY:
    ...
    default_headers["X-RapidAPI-Host"] = "forexwala.p.rapidapi.com"
else:
...
client = httpx.AsyncClient(
    base_url="https://forexwala.p.rapidapi.com", 
    timeout=30.0
)
...
async def _add_rapidapi_headers(method, url, **kwargs):
    ...
    if API_KEY:
        ...
        kwargs['headers']['X-RapidAPI-Host'] = "forexwala.p.rapidapi.com"
    else:
